...
describe("POST /", () => {
  ...
  test("It should give the correct response given the correct payload", done => {
    supertest(app)
      .post("/")
      .send(TEST_PAYLOAD)
      .then(response => {
  ...
  test("It should give a 400 with an appropriate error message given an empty payload", done => {
    supertest(app)
      .post("/")
      .send({})
      .then(response => {
  ...
  test("It should give a 400 with an appropriate error message given a non-JSON payload", done => {
    supertest(app)
      .post("/")
      .send("!@#$!@#$!@#$")
      .then(response => {
